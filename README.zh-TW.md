...
Lumen Streets 在瀏覽器裡，將真實街道、建築與鐵路畫成城市夜景。調整光線、為桌面圖示留白，再匯出一張屬於你的夜景桌布。
...
- **有層次的光。** 金色大道、建築立面、零星窗光與柔和岸邊倒影。「航拍金夜」加入藝術化的 2.5D 建築；琥珀夜與藍夜保留平面插畫風格。調整亮度與車流，看列車穿過城市。
...
詳見[匯出格式與設定](docs/EXPORTS.md)及[場景分享](docs/SCENES.md)。影片循環時會重新接回開頭，並非無縫循環；目前未提供 iPhone Live Photo 轉換。
