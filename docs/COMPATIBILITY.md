...
| Android 16 / Chrome 152, ROG 8 Pro | Repeated startup, current artwork in all eight maps, three palettes, both languages and PNG generation; earlier checks covered GIF/MP4/WebM downloads, scene reopening, gestures and rotation | Long 1440p exports have not been retested on the device |
