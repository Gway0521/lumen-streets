...
| Android 16 / Chrome 152, ROG 8 Pro | Before the building-depth update: repeated startup, all eight maps, three palettes, both languages and PNG generation; earlier checks covered GIF/MP4/WebM downloads, scene reopening, gestures and rotation | The new structure atlas and long 1440p exports have not been retested on the device |
...
- Aerial Gold caches an additional structure layer for building occlusion. Dense scenes and exports use more memory than the flat palettes; physical-phone validation of this update is still pending.
