...
Building delivery and background updates are described in [Global building service](GLOBAL-BUILDING-SERVICE.md). The former optional regional manifest is no longer the default browser path.
